...
The pretrained StarGANv2 on VCTK corpus can be downloaded at [StarGANv2 Link](https://huggingface.co/yl4579/StarGANv2-VC/blob/main/BIGvGAN/Models.zip). The BIGVGAN model can be downloaded at [BIGVGAN repo](https://github.com/NVIDIA/BigVGAN). This recipe also works with the [Hifi-GAN repo](https://github.com/jik876/hifi-gan). 
